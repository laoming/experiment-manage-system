        ...
        mainAppElement.innerHTML = `
            <div style="padding:40px; text-align:center; background:#f5f5f5;">
                ...
                <div style="margin-top:30px;">
                    ...
                    <button onclick="window.location.href='/ems/pages/home.html'" style="padding:12px 24px; background:#fff; color:#333; border:1px solid #ddd; border-radius:4px; cursor:pointer; font-size:16px;">🏠 返回首页</button>
                </div>
            </div>
        `;
    }
